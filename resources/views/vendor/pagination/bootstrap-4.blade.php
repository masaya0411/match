@if ($paginator->hasPages())
    <ul class="c-pagination" role="navigation">
        ...
        @if ($paginator->onFirstPage())
            <li class="c-pagination__item" aria-disabled="true" aria-label="@lang('pagination.previous')">
        ...
        @else
            <li class="c-pagination__item" aria-disabled="true" aria-label="@lang('pagination.next')">
